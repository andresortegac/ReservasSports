...
return [
    ...
    */
    ...
    'connections' => [
        ...
        /*
        |--------------------------------------------------------------------------
        | ✅ NUEVA CONEXIÓN MYSQL EXTERNA
        |--------------------------------------------------------------------------
        | Esta conexión apunta a otra base de datos.
        | Usa variables DB_EXTERNAL_* del .env
        */
        'external' => [
            'driver' => 'mysql',
            ...
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                (PHP_VERSION_ID >= 80500 ? \Pdo\Mysql::ATTR_SSL_CA : \PDO::MYSQL_ATTR_SSL_CA) => env('MYSQL_EXTERNAL_ATTR_SSL_CA'),
            ]) : [],
        ],
